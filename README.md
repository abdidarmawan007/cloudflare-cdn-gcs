...
### after domain alredy verification by google create bucket with your domain for example cdn.yourdomain.id
### create bucket with single region for example in singapore
